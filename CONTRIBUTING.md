# Contributing to Snapmaker2-Modules

We would love for your to contribute to Snapmaker2-Modules and help make it better.
...
As contributors and maintainers of the Snapmaker2-Modules project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.

Communication through any of Snapmaker2-Modules' channels (GitHub, Forum, Facebook Group, etc.) must be constructive and never resort to personal attacks, trolling, public or private harassment, insults, or other unprofessional conduct.

If any member of the community violates this code of conduct, the maintainers of the Snapmaker2-Modules project may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.

## <a name="issue"></a> Found a Bug?

If you found a bug in the source code, you can help us by [submitting a issue](https://github.com/Snapmaker/Snapmaker2-Modules/issues/new) to our [Github repository](https://github.com/Snapmaker/Snapmaker2-Modules).
...
You can *request a new feature* by [submitting an issue](https://github.com/Snapmaker/Snapmaker2-Modules/issues/new) to our [Github repository](https://github.com/Snapmaker/Snapmaker2-Modules) as well.
...
3. Fork the `Snapmaker/Snapmaker2-Modules` repo.
...
8. Push your branch to Github:
    ...
    ```
9. In Github, send a pull request to `Snapmaker/Snapmaker2-Modules`.
