...
struct inv_imu_device {
	...
	void (*sensor_event_cb)(struct inv_imu_device *s, inv_imu_sensor_event_t *event); /**< callback executed by:
...
int inv_imu_init(struct inv_imu_device *s,
                 ...
                 void (*sensor_event_cb)(struct inv_imu_device *s, inv_imu_sensor_event_t *event));
